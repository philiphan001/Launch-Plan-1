...
export const financialProjections = pgTable("financial_projections", {
  ...
  startingAge: integer("starting_age").notNull(),
  startingSavings: integer("starting_savings").notNull(),
  income: integer("income").notNull(),
  expenses: integer("expenses").notNull(),
  incomeGrowth: real("income_growth").notNull(),
  studentLoanDebt: integer("student_loan_debt").notNull(),
  includesCollegeCalculation: boolean("includes_college_calculation").default(false),
  includesCareerCalculation: boolean("includes_career_calculation").default(false),
  collegeCalculationId: integer("college_calculation_id"),
  careerCalculationId: integer("career_calculation_id"),
  locationAdjusted: boolean("location_adjusted").default(false),
  locationZipCode: text("location_zip_code"),
  costOfLivingIndex: real("cost_of_living_index"),
  incomeAdjustmentFactor: real("income_adjustment_factor"),
  emergencyFundAmount: integer("emergency_fund_amount").notNull(),
  personalLoanTermYears: integer("personal_loan_term_years").notNull(),
  personalLoanInterestRate: real("personal_loan_interest_rate").notNull(),
  createdAt: timestamp("created_at").defaultNow(),
});
