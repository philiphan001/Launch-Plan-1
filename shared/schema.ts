...
export const financialProjections = pgTable("financial_projections", {
  ...
  startingSavings: integer("starting_savings"),
  income: integer("income"),
  expenses: integer("expenses"),
  incomeGrowth: real("income_growth"),
  studentLoanDebt: integer("student_loan_debt"),
  includesCollegeCalculation: boolean("includes_college_calculation"),
  includesCareerCalculation: boolean("includes_career_calculation"),
  collegeCalculationId: integer("college_calculation_id"),
  careerCalculationId: integer("career_calculation_id"),
  locationAdjusted: boolean("location_adjusted"),
  ...
  personalLoanTermYears: integer("personal_loan_term_years"),
  personalLoanInterestRate: real("personal_loan_interest_rate"),
  createdAt: timestamp("created_at").defaultNow(),
});
...
export const milestones = pgTable("milestones", {
  ...
  spouseBaseIncome: integer("spouse_base_income"),
