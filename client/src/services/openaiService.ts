...
// Note: For frontend code, we don't access OPENAI_API_KEY directly,
// as API calls will be routed through our backend to protect the key
const openai = new OpenAI({
  apiKey: 'dummy-key', // This is a placeholder, actual key is managed by the server
