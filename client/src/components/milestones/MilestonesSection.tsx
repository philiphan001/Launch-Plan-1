...
const MilestonesSection = ({
  ...
  const {
    data: futureSavings,
    isLoading: isLoadingFutureSavings,
    refetch: refetchFutureSavings,
  } = useQuery({
    queryKey: ["/api/calculate/future-savings", userId, yearsAway],
    queryFn: async () => {
      if (!userId) {
        console.log(
          "Warning: Attempting to calculate future savings without a valid userId"
        );
        return {
  ...
  const openMilestoneDialog = (
    ...
    if (milestoneToEdit) {
      ...
      if (type === "marriage") {
        ...
        setChildrenCount(1);
        setChildrenExpensePerYear(
          milestoneToEdit.childrenExpensePerYear || 12000
        );
        ...
        setReturnToSameProfession(
          milestoneToEdit.returnToSameProfession !== false
        );
      ...
      if (type === "marriage") {
        ...
        setHomeDownPayment(
          defaultHomeValue * (defaultDownPaymentPercent / 100)
        );
  ...
  const handleSaveMilestone = () => {
    ...
    if (currentMilestone === "marriage") {
      ...
      try {
        // Ensure we have a valid number for spouse income
        adjustedIncome =
          typeof spouseIncome === "number" && !isNaN(spouseIncome)
            ? spouseIncome
            : 50000;
        ...
        adjustedIncome = Math.round(adjustedIncome * locationFactor);
      } catch (error) {
      ...
      const milestone = {
        ...
        yearsAway,
        spouseOccupation,
        spouseIncome: adjustedIncome, // Only use spouseIncome
      ...
      const milestoneData = {
        ...
        details: {
          roommateCount:
            roommateHousingReduction === 0.5
              ? 1
              : roommateHousingReduction === 0.67
                ? 2
                : roommateHousingReduction === 0.75
                  ? 3
                  : 1,
      ...
      <Card className="mb-6">
        <CardContent className="p-6">
          ...
          <p className="text-gray-600 mb-4">
            Add major life events to see how they impact your financial
            projection.
          </p>
            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg p-4 border border-pink-200">
                  <div className="flex justify-center mb-4">
                    <div className="flex items-center space-x-2 bg-white py-2 px-4 rounded-full shadow-sm border border-pink-200">
                      ...
                      <h3 className="text-lg font-medium bg-gradient-to-r from-pink-500 to-purple-500 text-transparent bg-clip-text">
                        Your Future Power Couple Goals
                      </h3>
                      <Heart className="h-5 w-5 text-pink-500 animate-pulse" />
                    </div>
                  </div>
                  ...
                  <Tabs defaultValue="dream" className="w-full">
                    <TabsList className="grid w-full grid-cols-3 bg-pink-100">
                      <TabsTrigger
                        value="dream"
                        className="data-[state=active]:bg-pink-200"
                      >
                        The Dream
                      </TabsTrigger>
                      <TabsTrigger
                    ...
                    <TabsContent
                      value="dream"
                      className="bg-white rounded-md p-4 mt-4 border border-pink-100 shadow-sm"
                    >
                      <div className="space-y-4">
                        <div className="text-center mb-4">
                          <p className="text-sm text-gray-600">
                            Who will you marry? Choose their dream job!
                          </p>
                        </div>

                        <div>
                          <Label
                            htmlFor="spouse-occupation"
                            className="text-purple-700 font-medium flex items-center"
                          >
                            <span className="mr-2">💼</span> Future Spouse's
                            Career
                          </Label>
                          <div className="mt-2 relative">
                            {/* COPYING EXACT PATTERN FROM EDUCATION MILESTONE */}
                            <Popover>
                                ...
                                <Command>
                                  <div className="px-3 py-2 border-b border-pink-100 bg-gradient-to-r from-pink-50 to-purple-50">
                                    <p className="text-xs text-center font-medium text-pink-600">
                                      💼 What career does your future spouse
                                      have?
                                    </p>
                                  </div>
                                  <CommandInput
                                    placeholder="Type to search careers..."
                                    className="h-9 border-pink-100"
                                  />
                                            ...
                                            <CommandItem
                                              ...
                                              onSelect={() => {
                                                try {
                                                  ...
                                                  console.log(
                                                    `Set spouse occupation to: ${title} with income: ${salary}`
                                                  );
                                                } catch (error) {
                                                  console.error(
                                                    "Error setting spouse career:",
                                                    error
                                                  );
                            ...
                            <div className="mt-4">
                              <div className="flex gap-3">
                                <div className="flex-1">
                                  <Label
                                    htmlFor="manual-occupation"
                                    className="text-xs text-pink-700"
                                  >
                                    Manual Job Title (Optional)
                                  </Label>
                                  <Input
                        ...
                        {spouseOccupation && (
                          <div className="bg-gradient-to-r from-pink-50 to-purple-50 p-3 rounded-lg border border-pink-100 mt-4">
                            ...
                            <div className="mt-3 text-xs text-gray-600 bg-white p-2 rounded border border-pink-100">
                              <span className="font-medium">Pro tip:</span> Two
                              incomes can help you reach financial goals faster,
                              like buying a home or traveling!
                            </div>
                          </div>
                        )}
                      </div>
                    ...
                    >
                      <div className="space-y-4">
                        <div className="text-center mb-3">
                          <p className="text-sm text-gray-600">
                            Marriage isn't just about love... it's teamwork! 👫
                          </p>
                        </div>
                        ...
                        <div className="mt-3 text-sm bg-blue-50 p-3 rounded-lg border border-blue-100">
                          ...
                          <p className="mt-1 text-gray-700">
                            The average age for marriage in the US is 30 for men
                            and 28 for women. Most financial experts recommend
                            being financially stable before marriage!
                          </p>
                        </div>
                      </div>
                    </TabsContent>
                    ...
                    >
                      <div className="space-y-4">
                        <div className="text-center mb-3">
                          <p className="text-sm text-gray-600">
                            Marriage affects your money in ways you might not
                            expect! 💵
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500 mt-1 italic">
                            {spouseOccupation
                              ? "Salary from their career (you can adjust it)"
                              : "How much will they make? Take a guess!"}
                          </div>
                        </div>
                          ...
                          <div>
                            ...
                            <div className="flex items-center mt-1">
                              ...
                              <Input
                                ...
                                value={spouseAssets}
                                onChange={(e) =>
                                  setSpouseAssets(Number(e.target.value))
                                }
                                className="border-green-200 focus:ring-green-500"
                              />
                            </div>
                          ...
                          <div>
                            ...
                            <div className="flex items-center mt-1">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setSpouseLiabilities(Number(e.target.value))
                                }
                        ...
                        <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200 mt-4">
                          <div className="flex items-center font-medium text-yellow-700 mb-2">
                            <span className="mr-2">🧮</span> Financial Impact
                            Calculator
                          </div>
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div className="bg-white rounded p-2 border border-yellow-100">
                              ...
                              <div
                                className={`font-bold ${
                                  typeof spouseAssets === "number" &&
                                  typeof spouseLiabilities === "number" &&
                                  spouseAssets - spouseLiabilities > 0
                                    ? "text-green-600"
                                    : "text-red-500"
                                }`}
                              >
              ...
              {currentMilestone === "home" && (
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 p-3 rounded-md border border-blue-200">
                    ...
                    {yearsAway > 0 &&
                      futureSavings &&
                      homeDownPayment > futureSavings.futureSavings && (
                        <div className="mt-2 text-sm text-red-600 flex items-center">
                          <AlertTriangle className="h-4 w-4 mr-1" />
                          Your down payment would exceed your projected savings
                          in {yearsAway} years
                        </div>
                      )}

                    {yearsAway === 0 &&
                      financialProfile?.savingsAmount &&
                      homeDownPayment > financialProfile.savingsAmount && (
                        <div className="mt-2 text-sm text-red-600 flex items-center">
                          <AlertTriangle className="h-4 w-4 mr-1" />
                          Your down payment exceeds your current available
                          savings
                        </div>
                      )}
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          if (newValue > 0 && homeValue > 0) {
                            ...
                            setHomeDownPayment(
                              Math.round(newValue * currentPercent)
                            );
                          } else if (newValue > 0) {
                  ...
                  <div>
                    <Label htmlFor="home-down-payment">
                      Down Payment Percentage
                    </Label>
                    <div className="flex items-center mt-2">
                      <span className="mr-4 text-sm w-8">
                        {homeValue > 0
                          ? Math.round((homeDownPayment / homeValue) * 100)
                          : 20}
                        %
                      </span>
                      <Slider
                        ...
                        onValueChange={(value) => {
                          if (homeValue > 0) {
                            setHomeDownPayment(
                              Math.round(homeValue * (value[0] / 100))
                            );
                          }
                        }}
                        className="flex-1"
                      />
                      <span className="ml-4 text-sm w-8">
                        ${homeDownPayment.toLocaleString()}
                      </span>
                    </div>
                  ...
                  <div>
                    <Label htmlFor="home-monthly-payment">
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setHomeMonthlyPayment(Number(e.target.value))
                        }
                      />
                    </div>
                    <div className="text-sm text-gray-500 mt-1">
                      Includes principal, interest, taxes, insurance, and
                      maintenance
                    </div>
                    <Button
                      variant="outline"
                      ...
                      onClick={() => {
                        ...
                        if (homeDownPayment >= homeValue) {
                          alert(
                            "Down payment must be less than the home value."
                          );
                          return;
                        }
                        ...
                        const calculatedTotal =
                          ...
                          maintenance;
                        const total =
                          !isNaN(calculatedTotal) && isFinite(calculatedTotal)
              ...
              {currentMilestone === "car" && (
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 p-3 rounded-md border border-blue-200">
                    ...
                    {yearsAway > 0 &&
                      futureSavings &&
                      carDownPayment > futureSavings.futureSavings && (
                        <div className="mt-2 text-sm text-red-600 flex items-center">
                          <AlertTriangle className="h-4 w-4 mr-1" />
                          Your down payment would exceed your projected savings
                          in {yearsAway} years
                    ...
                    {yearsAway === 0 &&
                      financialProfile?.savingsAmount &&
                      carDownPayment > financialProfile.savingsAmount && (
                        <div className="mt-2 text-sm text-red-600 flex items-center">
                          <AlertTriangle className="h-4 w-4 mr-1" />
                          Your down payment exceeds your current available
                          savings
                  ...
                  <div>
                    <Label htmlFor="car-down-payment">
                      Down Payment Percentage
                    </Label>
                    <div className="flex items-center mt-2">
                      <span className="mr-4 text-sm w-8">
                        {carValue > 0
                          ? Math.round((carDownPayment / carValue) * 100)
                          : 20}
                        %
                      </span>
                      <Slider
                        ...
                        onValueChange={(value) => {
                          if (carValue > 0) {
                            setCarDownPayment(
                              Math.round(carValue * (value[0] / 100))
                            );
                          }
                        }}
                        className="flex-1"
                  ...
                  <div>
                    <Label htmlFor="car-monthly-payment">
                      Monthly Payment (Estimated)
                    </Label>
                    <div className="flex items-center mt-1">
                      <span className="mr-2">$</span>
                      <Input
                        ...
                        onChange={(e) =>
                          setCarMonthlyPayment(Number(e.target.value))
                        }
                      />
                    </div>
                    <div className="text-sm text-gray-500 mt-1">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (carValue <= 0) {
                          alert(
                            "Please enter a valid car value greater than zero."
                          );
                          return;
                        }
                        ...
                        if (carDownPayment >= carValue) {
                          alert(
                            "Down payment must be less than the car value."
                          );
                          return;
                        }
                        ...
                        // Total monthly payment - validate for NaN or Infinity
                        const calculatedTotal =
                          loanPayment + insurance + maintenance;
                        const total =
                          !isNaN(calculatedTotal) && isFinite(calculatedTotal)
                            ? Math.round(calculatedTotal)
              ...
              {currentMilestone === "children" && (
                <div className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="children-expense">
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setChildrenExpensePerYear(Number(e.target.value))
                        }
                      />
                    </div>
                    <div className="text-sm text-gray-500 mt-1">
                      Total annual cost: $
                      {(
                        childrenCount * childrenExpensePerYear
                      ).toLocaleString()}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 bg-gradient-to-r from-purple-50 to-indigo-50 p-4 rounded-lg border border-purple-200">
                  <div className="flex justify-center mb-4">
                    <div className="flex items-center space-x-2 bg-white py-2 px-4 rounded-full shadow-sm border border-purple-200">
                      ...
                      <h3 className="text-lg font-medium bg-gradient-to-r from-purple-500 to-indigo-500 text-transparent bg-clip-text">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => {
                        ...
                        console.log(
                          `Is Graduate Program: ${["masters", "phd", "mba", "jd", "md"].includes(value)}`
                        );
                  ...
                  <div>
                    <Label htmlFor="education-annual-cost">
                      Annual Program Cost
                    </Label>
                    <div className="flex items-center mt-1">
                      <span className="mr-2">$</span>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Total program cost: $
                      {(educationAnnualCost * educationYears).toLocaleString()}
                    </p>
                  </div>

                  <div>
                    <Label htmlFor="education-annual-loan">
                      Annual Loan Amount
                    </Label>
                    <div className="flex items-center mt-1">
                      <span className="mr-2">$</span>
                      <Input
                        ...
                        onChange={(e) =>
                          setEducationAnnualLoan(Number(e.target.value))
                        }
                      />
                    </div>
                    <p className="text-xs text-gray-500 mt-1">
                      Total loans: $
                      {(educationAnnualLoan * educationYears).toLocaleString()}
                    </p>
                  </div>

                  <div className="bg-white rounded-md p-3 border border-purple-100 mt-3">
                    <h4 className="font-medium text-purple-700 mb-2">
                      Working Status During Education
                    </h4>
                    <RadioGroup
                      value={workStatus}
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="work-status-no" className="font-normal">
                          Not working during education
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem
                          value="part-time"
                          id="work-status-part-time"
                        />
                        <Label
                          htmlFor="work-status-part-time"
                      ...
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem
                          value="full-time"
                          id="work-status-full-time"
                        />
                        <Label
                          htmlFor="work-status-full-time"
                          className="font-normal"
                        >
                          Working full-time
                        </Label>
                    ...
                    {workStatus === "part-time" && (
                      <div className="mt-3 border-t border-purple-100 pt-3">
                        <Label htmlFor="part-time-income" className="text-sm">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Estimated annual income from part-time work during
                          studies
                        </p>
                      </div>
                    )}
                  ...
                  <div className="bg-white rounded-md p-3 border border-purple-100 mt-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      ...
                      <div className="font-medium text-right">
                        $
                        {(
                          educationAnnualCost * educationYears
                        ).toLocaleString()}
                      </div>
                      ...
                      <div className="font-medium text-right">
                        $
                        {(
                          educationAnnualLoan * educationYears
                        ).toLocaleString()}
                      </div>
                      ...
                      <div className="mt-3 text-xs border-t border-purple-100 pt-2">
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600">
                            Projected savings in {yearsAway} years:
                          </span>
                        ...
                        Math.max(
                          ...
                          <div className="mt-2 bg-red-50 text-red-700 p-2 rounded-md border border-red-100 flex items-start">
                            ...
                            <span>
                              You may need to increase your savings rate or loan
                              amount to cover the education costs.
                            </span>
                          </div>
                        ) : (
                          <div className="mt-2 bg-green-50 text-green-700 p-2 rounded-md border border-green-100">
                            Your projected savings should cover the education
                            costs not funded by loans.
                          </div>
                        )}
                      </div>
                    )}
                  ...
                  <div className="bg-white rounded-md p-3 border border-purple-100 mt-4">
                    ...
                    <div className="space-y-4">
                      <div className="bg-purple-50 p-3 rounded-lg border border-purple-100">
                        ...
                        <RadioGroup
                          ...
                          onValueChange={(val: string) =>
                            setReturnToSameProfession(val === "same")
                          }
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem
                              value="same"
                              id="return-same-profession"
                            />
                            <Label
                              htmlFor="return-same-profession"
                              className="font-normal"
                            >
                              Return to same profession
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem
                              value="new"
                              id="enter-new-profession"
                            />
                            <Label
                              htmlFor="enter-new-profession"
                              className="font-normal"
                            >
                      ...
                      <Label
                        htmlFor="target-occupation"
                        className="text-purple-700 font-medium flex items-center"
                      >
                        <span className="mr-2">💼</span>{" "}
                        {returnToSameProfession
                          ? "Your Profession After Graduation"
                          : "New Occupation After Graduation"}
                      </Label>
                      <div className="mt-2 relative">
                        <Popover>
                          <PopoverTrigger asChild>
                          ...
                          >
                            <Command>
                              <div className="px-3 py-2 border-b border-purple-100 bg-gradient-to-r from-purple-50 to-indigo-50">
                                <p className="text-xs text-center font-medium text-purple-600">
                                  💼 What career do you want after graduating?
                                </p>
                              </div>
                              <CommandInput
                                placeholder="Type to search careers..."
                                className="h-9 border-purple-100"
                              />
                              <CommandList className="max-h-[300px] overflow-auto">
                                <CommandEmpty>
                                  No matching careers found
                                    ...
                                    .map((career) => (
                                      <CommandItem
                                        ...
                                        onSelect={() => {
                                          ...
                                          console.log(
                                            `Setting target occupation to: ${career.title}`
                                          );
                                          setTargetOccupation(
                                            career.title || ""
                                          );
                    ...
                    {targetOccupation && (
                      <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-3 rounded-lg border border-purple-100 mt-4">
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <div className="mt-1 font-medium text-lg text-green-600">
                              $
                              {careers
                                ?.find((c) => c.title === targetOccupation)
                          ...
                          <div className="text-5xl">
                            {(careers?.find((c) => c.title === targetOccupation)
                              ?.salaryMedian || 0) > 100000
                              ? "🤑"
                              : (careers?.find(
                                    (c) => c.title === targetOccupation
                                  )?.salaryMedian || 0) > 70000
                                ? "😎"
                                : (careers?.find(
                                      (c) => c.title === targetOccupation
                                    )?.salaryMedian || 0) > 40000
                                  ? "🙂"
                                  : "😅"}
                          </div>
                        </div>
                        ...
                        <div className="mt-3 text-xs text-gray-600 bg-white p-2 rounded border border-purple-100">
                          <span className="font-medium">Pro tip:</span> Advanced
                          degrees can open doors to higher-paying roles and
                          specialized positions in your field!
                        </div>
                      </div>
                    )}
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        setRoommateHousingReduction(Number(value) / 100)
                      }
                    ...
                    >
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="one-roommate" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Split costs 50/50 - reduces your housing costs by
                            50%
                          </div>
                        </Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="two-roommates" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Split costs three ways - reduces your housing costs
                            by 67%
                          </div>
                        </Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="three-roommates" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Split costs four ways - reduces your housing costs
                            by 75%
                          </div>
                        </Label>
                      </div>
                    ...
                    <div className="text-sm text-gray-500 mt-3">
                      Choose how many roommates you plan to live with. More
                      roommates means lower housing costs, but consider your
              ...
              {currentMilestone === "insurance" && (
                <div className="space-y-4">
                  <div>
                    ...
                    <RadioGroup
                      value={String(
                        Math.round((insuranceReduction || 0.2) * 100)
                      )}
                      onValueChange={(value) =>
                        setInsuranceReduction(Number(value) / 100)
                      }
                      className="mt-2 space-y-3"
                    >
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="basic-insurance" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Switch to minimum required coverage - reduces
                            insurance costs by 20%
                          </div>
                        </Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="shop-insurance" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Find a better insurance provider - reduces insurance
                            costs by 35%
                          </div>
                        </Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="bundle-insurance" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Combine multiple insurance policies - reduces
                            insurance costs by 50%
                          </div>
                        </Label>
                      </div>
                    </RadioGroup>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        setDiningReduction(Number(value) / 100)
                      }
                      className="mt-2 space-y-3"
                    >
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="moderate-dining" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Cook at home more often - reduces dining expenses by
                            30%
                          </div>
                        </Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="significant-dining" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Limit dining out to special occasions - reduces
                            dining expenses by 50%
                          </div>
                        </Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="minimal-dining" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Cook almost all meals at home - reduces dining
                            expenses by 75%
                          </div>
                        </Label>
                      </div>
              ...
              {currentMilestone === "shopping" && (
                <div className="space-y-4">
                  <div>
                    ...
                    <RadioGroup
                      value={String(
                        Math.round((shoppingReduction || 0.25) * 100)
                      )}
                      onValueChange={(value) =>
                        setShoppingReduction(Number(value) / 100)
                      }
                      className="mt-2 space-y-3"
                    >
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="moderate-shopping" className="flex-1">
                          <div className="font-medium">Moderate Reduction</div>
                          <div className="text-sm text-gray-500">
                            Buy less non-essential items - reduces shopping
                            expenses by 25%
                          </div>
                        </Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        >
                          ...
                          <div className="text-sm text-gray-500">
                            Focus on essentials only - reduces shopping expenses
                            by 50%
                          </div>
                        </Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50">
                        ...
                        <Label htmlFor="minimal-shopping" className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">
                            Essential purchases only - reduces shopping expenses
                            by 75%
                          </div>
                        </Label>
                      </div>
