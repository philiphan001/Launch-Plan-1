                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="mt-3 flex space-x-2">
                          ...
                          <Button 
                            ...
                            className={isCollegeFavorite(college.id) ? "!bg-slate-900 text-white hover:!bg-slate-800" : ""}
            ...
            <>
              ...
              <DialogFooter className="flex gap-2">
                <Button 
                  ...
                  className={isCollegeFavorite(selectedCollege.id) ? "!bg-slate-900 text-white hover:!bg-slate-800" : ""}
