...
const CareerBuilder: React.FC<CareerBuilderProps> = ({
  ...
  const {
    ...
    queryFn: async () => {
      ...
      try {
        return await FavoritesService.getFavoriteCareersByUserId(userId);
      } catch (error) {
        ...
        timeline: [
          {
            ...
            stage: "education",
            description:
              "Graduate high school and begin your education journey",
            earnings: 0,
          },
          {
            year: 4,
            stage: "education",
            description: "Complete relevant degree or training",
            earnings: 0,
          },
          {
            year: 5,
            stage: "entry",
            description: "First professional position",
            earnings: 45000,
          },
          {
            year: 8,
            stage: "mid",
            description: "Mid-level position with more responsibilities",
            earnings: 65000,
          },
          {
            year: 15,
            stage: "senior",
            description: "Senior position with leadership opportunities",
            earnings: 90000,
          },
        ],
      });
  ...
  const useTimelineData = () => {
    if (!timeline || !timeline.timeline || timeline.timeline.length === 0) {
      toast({
        ...
        description:
          "There is no timeline data available for this career yet. Try analyzing the career first.",
        variant: "destructive",
      });
      return;
    }
    ...
    const entryPosition = timeline.timeline.find(
      (step) => step.stage === "entry" && step.earnings
    );
    ...
    // Get education info
    const educationSteps = timeline.timeline.filter(
      (step) => step.stage === "education"
    );
    const educationStep =
      educationSteps.length > 0
        ? educationSteps[educationSteps.length - 1]
        : null;
    ...
    const notes = [
      ...
      entryPosition
        ? `Entry Level (Year ${entryPosition.year}): ${entryPosition.description}`
        : "",
      latestPosition
        ? `Career Peak (Year ${latestPosition.year}): ${latestPosition.description}`
        : "",
    ]
      .filter(Boolean)
      .join("\n\n");
    ...
    toast({
      ...
      description:
        "Career timeline information has been applied to your financial projections.",
      variant: "default",
    });
  };
  ...
  const createCareerCalculation = useMutation({
    mutationFn: async () => {
      ...
      const entryLevelSalary =
        selectedCareer.salaryPct10 ||
        Math.round((selectedCareer.salary || 0) * 0.6);
      const midCareerSalary =
        selectedCareer.salaryMedian || selectedCareer.salary || 0;
      const experiencedSalary =
        selectedCareer.salaryPct90 ||
        Math.round((selectedCareer.salary || 0) * 1.4);

      const calculationData = {
        userId,
        careerId: selectedCareer.id,
        projectedSalary:
          typeof projectedSalary === "string"
            ? parseInt(projectedSalary)
            : projectedSalary,
        startYear:
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.message || "Failed to save career calculation"
        );
      }
    ...
    return (
      <div className="flex flex-col items-center justify-center h-96">
        ...
        <p className="mt-4 text-muted-foreground">
          Loading your career information...
        </p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <Alert variant="destructive" className="max-w-4xl mx-auto mt-8">
        <AlertDescription>
          We encountered an error loading your favorite careers. Please try
          again later.
        </AlertDescription>
      </Alert>
    );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 mb-6">
        Explore detailed insights and career pathways for your favorite
        occupations with AI-powered analysis.
      </p>
        ...
        <div className="md:col-span-1">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select a career to view AI-enhanced insights
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <div className="space-y-6">
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-bold">
                            ${selectedCareer.salary.toLocaleString()}
                          </p>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="flex items-start mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            How much you might earn at different
                            experience/performance levels
                            {(!selectedCareer.salaryPct10 ||
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span className="font-medium">
                              ...
                              {(
                                selectedCareer.salaryPct10 ||
                                Math.round(selectedCareer.salary * 0.6)
                              ).toLocaleString()}
                            </span>
                          </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span className="font-medium">
                              ...
                              {(
                                selectedCareer.salaryPct25 ||
                                Math.round(selectedCareer.salary * 0.8)
                              ).toLocaleString()}
                            </span>
                          </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span className="font-medium">
                              ...
                              {(
                                selectedCareer.salaryPct75 ||
                                Math.round(selectedCareer.salary * 1.2)
                              ).toLocaleString()}
                            </span>
                          </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span className="font-medium">
                              ...
                              {(
                                selectedCareer.salaryPct90 ||
                                Math.round(selectedCareer.salary * 1.4)
                              ).toLocaleString()}
                            </span>
                          </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Detailed information generated with AI about this career
                    path
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {loadingInsights ? (
                        ...
                        {loadingTimeline ? (
                          ...
                          <div className="relative pl-8 space-y-8 before:absolute before:inset-y-0 before:left-4 before:w-0.5 before:bg-gray-200">
                            {timeline.timeline.map((step, index: number) => (
                              <div
                                key={`timeline-${selectedCareer?.id}-${index}`}
                                className="relative"
                              >
                    ...
                    <div className="flex flex-col items-center justify-center py-8">
                      ...
                      <p className="text-center">
                        No insights available. Click the Analyze button to
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Save this career to include in your financial projections
                    and life planning
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {calculationSuccess ? (
                    <div className="text-center py-6 space-y-4">
                      ...
                      <p className="text-muted-foreground">
                        {selectedCareer.title} has been added to your financial
                        projections.
                      </p>
                      <Button
                        variant="outline"
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="projected-salary">
                      ...
                      <p className="text-xs text-muted-foreground text-center mt-2">
                        This will replace any previously included career in your
            ...
            <Card className="h-full flex items-center justify-center">
              <CardContent className="text-center py-12">
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  Choose a career from your favorites list to view detailed
                  AI-enhanced insights about the career pathway, education
